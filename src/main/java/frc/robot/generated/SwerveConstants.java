...
public final class SwerveConstants {
    ...
    public static final double TOP_SPEED_METERS_PER_SEC = TOP_SPEED_MOTOR_RPM * WHEEL_DIAMETER_METERS * Math.PI / DRIVE_GEAR_RATIO / 60; // = 5.123 m/s
    ...
    public static enum EncoderType {
        REDUX_ENCODER, SRX_MAG_ENCODER, REV_ENCODER, THRIFTY_ABSOLUTE_ENCODER, THRIFTY_10PIN_ENCODER, THRIFTY_ANALOG_ENCODER
    }

    public static enum GyroType {
        NAVX, PIGEON2, CANANDGYRO, NONE
    }
    ...
    public static final class ModuleConstants {
        ...
        public static final double FRONT_LEFT_ENCODER_OFFSET = 719; // Encoder offset in ticks
        ...
        public static final double FRONT_RIGHT_ENCODER_OFFSET = 4012; // Encoder offset in ticks
        ...
        public static final double BACK_LEFT_ENCODER_OFFSET = 3614; // Encoder offset in ticks
        ...
        public static final double BACK_RIGHT_ENCODER_OFFSET = 111; // Encoder offset in ticks
