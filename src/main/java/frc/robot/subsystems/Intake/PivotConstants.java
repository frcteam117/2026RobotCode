...
public class PivotConstants {
    ...
    public static class ProfileConstants {
        ...
        public static final AngularAcceleration kSparkMaxAcceleration = DegreesPerSecondPerSecond.of(45);
    }
    ...
    public static class TelemetryConstants {
        public static final String kMotorName = "ArmMotor";
        public static final String kArmName = "Arm";
